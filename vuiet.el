...
(defun vuiet-seek-backward-rate (arg)
  ...
  (interactive "p")
  (or arg (setq arg 10))
  (mpv-run-command "seek" (- arg) "relative-percent")
  (vuiet-update-mode-line))
